...
import com.mick.mmg.round.service.UserGuessService;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

import static org.junit.Assert.assertEquals;

public class UserGuessServiceTest {
    private UserGuessService userGuessService;
    private RoundEntity roundEntity;

    @BeforeEach
    public void beforeEach() {
        userGuessService = new UserGuessService();
    ...
    public void testEmptyGuess() {
        UserGuessResult userGuessResult = userGuessService.calculatePercentCorrect(
                roundEntity,
                new UserRoundGuess()
        );
